// CODE FROM https://rosettacode.org/wiki/Chinese_remainder_theorem#Swift - START
...
// CODE FROM https://rosettacode.org/wiki/Chinese_remainder_theorem#Swift - END
...
buses.enumerated().forEach { index, bus in
    if bus == -1 {
        return
    }
    n.append(bus)
